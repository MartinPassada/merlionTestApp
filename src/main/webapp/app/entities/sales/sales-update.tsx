...
import SimpleSelect from './materialUIsimpleSelect'
          ...
          {loading ? (
            <p>Loading...</p>
              ...
              <AvForm model={isNew ? {} : salesEntity} onSubmit={saveEntity}>
                ...
                <AvInput id="sales-id" type="text" className="form-control" name="id" required />*/}
                    <form className={classes.root} noValidate autoComplete="off">
                      <TextField type='text' required id="sales-id" label="sales-id" defaultValue={salesEntity.id} />
                    </form>
                  </AvGroup>
                ) : null}
                <AvGroup>
                  ...
                  <TextField type='text' id="sales-description" label="description" defaultValue={salesEntity.description} />
                </AvGroup>
                <AvGroup>
                  ...
                  <SimpleSelect value={(!isNew && salesEntity.state) || 'IN_CHARGE'} />
                </AvGroup>
                <AvGroup>
                ...
                <AvField id="sales-date" type="date" className="form-control" name="date" />*/}
                  <TextField type='text' id="sales-date" label="Date" defaultValue={salesEntity.date} />
                </AvGroup>
